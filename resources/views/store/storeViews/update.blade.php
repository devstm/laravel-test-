...
@section('table')
    ...
    <div class="kt-portlet">
        ...
        @endif
        <form class="kt-form kt-form--label-right" action="/edit/{{$model->id}}" method="post">
            {{ csrf_field() }}
            <div class="kt-portlet__body">
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" value="{{$model->name}}" type="text" name="name"
                               placeholder="user name" id="example-text-input">
                        @if ($errors->has('name'))
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" type="text" value="{{$model->currency_id}}" name="currency_id"
                               placeholder="user name" id="example-text-input">
                    </div>
                </div>
            </div>
